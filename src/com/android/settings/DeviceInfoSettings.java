...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
    ...
    private static final String KEY_LEGO_LOGO= "logo";
    ...
    private static final String KEY_LEGO_VERSION = "lego_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_LEGO_VERSION, "ro.lego.version");
        ...
        getPreferenceScreen().findPreference(KEY_LEGO_LOGO).setWidgetLayoutResource(R.layout.lego_logo);
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (preference.getKey().equals(KEY_LEGO_LOGO)) {
